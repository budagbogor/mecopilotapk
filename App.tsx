...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-950 text-slate-200 overflow-hidden selection:bg-blue-500/30 print:h-auto print:overflow-visible print:block pt-[env(safe-area-inset-top)]">
        ...
        <div className={`flex flex-col w-full md:w-[400px] lg:w-[450px] border-r border-slate-800 bg-slate-900 flex-shrink-0 ${currentJob ? 'hidden md:flex' : 'flex'} print:hidden`}>
          ...
          <div className="p-4 border-t border-slate-800 bg-slate-900/90 backdrop-blur-sm">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              {/* VIN Decoder */}
              <div className={`flex gap-2 p-1.5 rounded-xl border transition-all duration-300 ${decodedVehicle
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed ${decodedVehicle
              ...
              {(decodedVehicle || selectedMedia) && (
                <div className="flex gap-2 flex-wrap">
                  ...
                  {selectedMedia && (
                    <div className={`flex items-center border text-xs font-bold px-3 py-1.5 rounded-lg shadow-sm ${selectedMedia.mimeType.startsWith('image')
      ...
      {/* Footer */}
      <footer className="w-full bg-slate-900 border-t border-slate-800 py-3 pb-[env(safe-area-inset-bottom)] text-center z-20">
        <p className="text-[10px] text-slate-500 font-mono tracking-widest uppercase">CopyRight @2026 PSD Mobeng</p>
      </footer>
